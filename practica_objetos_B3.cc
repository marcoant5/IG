...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, EXTRUSION, TRONCO_PIRAMIDE, TEJADO, CILINDRO, CONO, ESFERA, TROFEO, BOMBILLA, ROTACION_PLY,
...
_tronco_piramide tronco_piramide(0.5,0.15,0.75);
...
{   
    ...
    Observer_distance=7.25*Front_plane;
    Observer_angle_x=27;
    Observer_angle_y=58;
...
{   
    ...
    Observer_distance=75*Front_plane;
    Observer_angle_x=24;
    Observer_angle_y=82;
}
...
switch (toupper(Tecla1)){
        ...
        case 'P':t_objeto=PIRAMIDE;restauraVista();break;
        case 'C':t_objeto=CUBO;restauraVista();break;
        case 'O':t_objeto=OBJETO_PLY;restauraVista();break;	
        case 'R':t_objeto=ROTACION;restauraVista();break;
        case 'X':t_objeto=EXTRUSION;restauraVista();break;
		case 'T':t_objeto=TEJADO;restauraVista();break;
        case 'Z':t_objeto=TRONCO_PIRAMIDE;restauraVista();break;
		case 'L':t_objeto=CILINDRO;restauraVista();break;
		case 'A':t_objeto=CONO;restauraVista();break;
        case 'E':t_objeto=ESFERA;restauraVista();break;
		case 'W':t_objeto=TROFEO;restauraVista();break;
		case 'B':t_objeto=BOMBILLA;restauraVista();break;
		case 'V':t_objeto=ROTACION_PLY;restauraVista();break;
        case 'G':t_objeto=EXCAVADORA;restauraVista();break;
        case 'F':t_objeto=MONTANA;restauraVista();break;
        case 'K':t_objeto=TEXTURA;restauraVista();break;
        case 'J':t_objeto=CUBOTEX;restauraVista();break;
        case 'D':t_objeto=SEMIESFERA;restauraVista();break;
        case 'H':t_objeto=TRONCO_CONO;restauraVista();break;
        case 'M':t_objeto=P38;vistaDiagonal();p38.valores_iniciales();animacion=0;break;
        case 'N':t_objeto=P38_ESCENA;vistaEscena();animacion=1;modo=SOLID_COLORS;/*Para que inicie animacion y con los colores solidos*/;break;
        /*case 'S':if (pulsar==0)
                    {giro1=1.0;
                     giro2=1.0;
                     giro3=0.25;
...
void special_key(int Tecla1,int x,int y)
{
    ...
    if(t_objeto==P38 || t_objeto==P38_ESCENA){
        switch (Tecla1){
            ...
            case GLUT_KEY_F12:p38.valores_iniciales();
                              animacion = 0;
                              break;
        }
    }
...
// Texturas modelo
prepara_textura("./texturas/suelo1.jpg", &textura_suelo);
